...
export class StatsDetails extends Component {
  ...
  render() {
    ...
    return (
      // <ScrollView>
      <AppBackground back title={'Stats Details'} marginHorizontal={false}>
        <View style={styles?.container}>
          <View style={{flex: 1, marginTop: 10, gap: 12}}>
            <TouchableOpacity
              style={styles.viewprofile}
              onPress={() => NavService.navigate('UserProfile')}>
              <View style={styles.subcontainer}>
                ...
                <View style={styles.nameContainer}>
                  <CustomText color={colors?.black} text={'John Smith'} />
                  <View
                    style={[
